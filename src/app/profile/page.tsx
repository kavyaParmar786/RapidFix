    ...
    <>
      ...
      <div className="min-h-screen pt-16" style={{ background: 'var(--bg-base)' }}>
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-10">
          <h1 className="text-2xl font-bold text-white mb-8" style={{ fontFamily: 'var(--font-syne)' }}>
            My Profile
          </h1>
          ...
          <div className="glass-card p-6 mb-6">
            <div className="flex items-start gap-5 flex-wrap">
              ...
              <div className="relative flex-shrink-0">
                ...
                <label className="absolute -bottom-1.5 -right-1.5 flex h-7 w-7 cursor-pointer items-center justify-center rounded-full bg-indigo-500 border-2 border-[var(--bg-base)] text-white hover:bg-indigo-400 transition-colors">
                  {uploading ? (
              ...
              <button
                ...
                className="flex items-center gap-1.5 rounded-xl border border-white/15 bg-white/5 px-4 py-2 text-sm font-medium text-white/70 transition-all hover:bg-white/10 hover:text-white"
              >
          ...
          <div className="glass-card p-6 mb-6 space-y-5">
            <h3 className="font-semibold text-white" style={{ fontFamily: 'var(--font-syne)' }}>
              Personal Info
            </h3>
            ...
            {profile.role === 'worker' && (
              <>
                <div>
                  <label className="block text-xs font-medium text-white/50 mb-1.5">Experience</label>
                  {editing ? (
                    <input
                      type="text"
                ...
                <div>
                  <label className="block text-xs font-medium text-white/50 mb-2">Skills / Categories</label>
                  {editing ? (
                    ...
                    <div className="flex flex-wrap gap-2">
                      {(profile.skills || []).length === 0 ? (
                        <span className="text-sm text-white/40">No skills set</span>
                      ) : (
          ...
          {profile.role === 'worker' && (
            <div className="glass-card p-6">
              <h3 className="font-semibold text-white mb-4" style={{ fontFamily: 'var(--font-syne)' }}>
                Reviews ({reviews.length})
              </h3>
              {reviews.length === 0 ? (
                <p className="text-sm text-white/40">No reviews yet. Complete jobs to earn reviews.</p>
              ) : (
