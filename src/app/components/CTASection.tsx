          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link
                ...
                className="flex items-center gap-2 rounded-xl border border-black/20 bg-zinc-100 px-8 py-3.5 text-base font-semibold text-zinc-900 transition-all hover:bg-white/20"
              >
                Become a Worker
              </Link>
            </div>
