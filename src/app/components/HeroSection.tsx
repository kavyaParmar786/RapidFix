    ...
    <section className="relative min-h-screen flex items-center overflow-hidden pt-16">
      ...
      <div className="absolute inset-0 -z-10">
        <div
          ...
          style={{
            background: 'radial-gradient(ellipse 80% 60% at 50% -10%, rgba(99,102,241,0.25) 0%, transparent 60%), radial-gradient(ellipse 60% 50% at 80% 60%, rgba(139,92,246,0.15) 0%, transparent 50%), var(--bg-base)',
          }}
        />
        {/* Grid lines */}
        <div
            ...
            <div className="flex flex-wrap gap-2 mt-6">
              {CATEGORIES.slice(0, 5).map((cat) => (
                <Link
                  key={cat.value}
                  href="/auth/signup"
                  className="flex items-center gap-1.5 rounded-full border border-white/10 bg-white/5 px-3 py-1.5 text-xs font-medium text-white/70 transition-all hover:border-indigo-500/40 hover:bg-indigo-500/10 hover:text-indigo-300"
                >
                  {cat.icon} {cat.label}
                </Link>
              ))}
            ...
            <div className="relative flex flex-col items-center gap-4">
              ...
              >
                <div className="flex items-center gap-2.5 mb-2">
                  ...
                  <div>
                    <p className="text-xs font-semibold text-white">Electrician needed</p>
                    <p className="text-[10px] text-white/50">Posted 2 min ago</p>
                  </div>
                </div>
              ...
              <div className="flex items-start gap-3 w-full justify-between px-2">
                ...
                >
                  <div className="flex items-center gap-2 mb-2">
                    <div className="h-7 w-7 rounded-full bg-gradient-to-br from-indigo-400 to-violet-500 flex items-center justify-center text-xs font-bold text-white flex-shrink-0">R</div>
                    <div>
                  ...
                  <p className="text-[10px] text-white/50">"Fixed wiring in 30 mins!"</p>
                </div>
                ...
                >
                  <p className="text-[10px] font-semibold text-white/60 uppercase tracking-wider mb-1">Job Accepted</p>
                  <p className="text-xs font-bold text-white">Pipe Leak Repair</p>
                  <div className="mt-2 h-1 w-full rounded-full bg-white/10">
                    <div className="h-full w-3/4 rounded-full bg-gradient-to-r from-indigo-500 to-violet-500" />
                  </div>
                  <p className="text-[10px] text-white/50 mt-1">In Progress</p>
                </div>
              </div>
