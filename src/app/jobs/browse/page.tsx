          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
            <div className="flex items-start justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-white/40">{filtered.length} available job{filtered.length !== 1 ? 's' : ''}</p>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
          {filtered.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-24 text-center">
              ...
              <p className="text-base font-medium text-white/60 mb-1">No jobs found</p>
              <p className="text-sm text-white/25">Try a different category or check back soon</p>
            </div>
          ) : (
