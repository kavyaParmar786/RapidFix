        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2">
              {/* Tabs */}
              <div className="flex gap-1 rounded-xl border border-white/10 bg-white/5 p-1 mb-5 overflow-x-auto">
                {tabs.map((t) => (
                  <button
                    key={t.key}
              ...
              <div className="space-y-4">
                {filteredJobs.length === 0 ? (
                  <div className="glass-card p-12 text-center">
                    ...
                    <p className="font-medium text-white mb-1">No jobs yet</p>
              ...
              <div className="space-y-3">
                {chats.length === 0 ? (
                  <div className="glass-card p-6 text-center">
                    ...
                    <p className="text-sm text-white/50">No active chats</p>
                  </div>
                ) : (
                  chats.map((chat) => (
                    <Link
                      key={chat.id}
                      href={`/chat/${chat.id}`}
                      className="glass-card flex items-center gap-3 p-4 transition-all hover:border-white/20 hover:bg-white/5"
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-medium text-white truncate">{chat.workerName}</p>
