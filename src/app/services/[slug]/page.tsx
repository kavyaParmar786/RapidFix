      ...
      <div className="min-h-screen pt-14" style={{ background: 'var(--bg-base)' }}>
        ...
        <div className="border-b border-white/[0.06]">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16 text-center">
            <p className="text-xs font-medium text-white/30 uppercase tracking-widest mb-4">RapidFix Service</p>
            <h1 className="text-4xl sm:text-5xl font-bold text-white mb-4">{service.title}</h1>
            <p className="text-lg text-white/50 mb-8">{service.tagline}</p>
            <p className="text-sm text-white/35 max-w-xl mx-auto mb-10">{service.description}</p>
            <div className="flex items-center justify-center gap-4 flex-wrap">
              <Link href="/auth/signup" className="btn-primary px-6 py-2.5 text-sm">
                Book Now <ArrowRight size={14} className="ml-1.5" />
              </Link>
              <span className="text-sm text-white/30">Starting at <span className="text-white font-medium">{service.price}</span></span>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-4">
              <h2 className="text-xl font-bold text-white mb-6">Why RapidFix</h2>
              {[
          ...
          <div className="mt-16 text-center rounded-2xl border border-white/[0.08] bg-white/[0.02] p-10">
            ...
            <p className="text-sm text-white/40 mb-6">Create a free account and post your job in under 2 minutes.</p>
