        ...
        <div className="relative z-10 space-y-8">
          ...
          <div className="rounded-xl border border-black/[0.08] bg-white p-5 shadow-sm">
            <div className="flex gap-0.5 mb-3">
              {[...Array(5)].map((_, i) => (
                <svg key={i} className="h-3.5 w-3.5 fill-zinc-900" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
              ))}
            </div>
      ...
      <div className="flex flex-1 items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-7">
            ...
            <p className="text-sm text-zinc-400">Welcome back to RapidFix</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <button type="submit" disabled={submitting || googleLoading} className="btn-primary w-full mt-1 py-2.5">
              {submitting
                ? <><div className="h-3.5 w-3.5 rounded-full border border-white/40 border-t-white animate-spin mr-2" />Signing in…</>
          ...
          <p className="mt-6 text-center text-xs text-zinc-400">
            ...
            <Link href="/auth/signup" className="text-zinc-900 hover:text-zinc-900/80 font-medium transition-colors">Sign up free</Link>
          </p>
        </div>
      </div>
    </div>
